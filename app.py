...
def main(face_path):
    ...
    for audio_file_name in os.listdir(audio_dir):
        ...
        command = f'ffmpeg -y -framerate {fps} -i {temp_dir}/frame_%04d.png -vf "geq=lum(A):a=\'min(255,max(0,(a*255/1023)))\'" -s {frame_w}x{frame_h} -c:v prores_ks -profile:v 4444 -pix_fmt yuva444p10le {output_video_path}'
