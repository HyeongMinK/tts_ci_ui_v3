...
if __name__ == "__main__":
    ...
    output_audio_path = os.path.join(audio_dir, "output_audio.wav")
...
def main():
    ...
    audio_filename = os.path.splitext(os.path.basename(args.audio))[0]
    result_filename = f'results/result_voice_{audio_filename}.mp4'
    command = 'ffmpeg -y -i {} -i {} -strict -2 -q:v 1 {}'.format(args.audio, 'temp/result.avi', result_filename)
